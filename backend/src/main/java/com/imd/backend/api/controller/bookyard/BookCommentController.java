...
public class BookCommentController extends BaseCommentController<BookComment, BookReview, BookItem, CreateBookCommentDTO> {
    ...
    @Override
    protected BookComment buildComment(CreateBookCommentDTO dto) {
