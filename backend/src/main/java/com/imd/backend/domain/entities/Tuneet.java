...
public class Tuneet {
  ...
  private Tuneet(UUID id, UUID authorId, String textContent, TunableItem tunableItem, LocalDateTime createdAt) {
    this.id = id;
  ...
  public static Tuneet createNew(UUID userId, String textContent, TunableItem item) {
    final UUID id = UUID.randomUUID();
    final LocalDateTime createdAt = LocalDateTime.now();
    Tuneet tuneet =  new Tuneet(id, userId, textContent, item, createdAt);
    return tuneet;
  }
  ...
  public static Tuneet rebuild(
      ...
      return new Tuneet(id, authorId, textContent, item, createdAt);
  }
